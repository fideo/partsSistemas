      ...
      >
        <v-card>
          <v-img
            class="white--text"
            height="250px"
            src="/images/controlDeAcceso.jpg"
          >
            <v-container
              fill-height
              fluid
            >
              <v-layout fill-height>
                <v-flex
                  ...
                  flexbox
                >
                  <h1 class="blue-grey--text text--darken-4">Control de Acceso</h1>
                </v-flex>
              </v-layout>
            </v-container>
          </v-img>
          <v-card-title>
            <div class="pt-3">
              <h2 class="pt-3 pl-4">Parts Sistemas ofrece soluciones y sistemas basados en hardware y software para la administración y el control de los accesos</h2>
              <v-container
                fluid
                grid-list-md
              >
