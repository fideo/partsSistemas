    ...
    <v-layout>
      ...
      >
        <v-card>
          ...
          <v-card-title>
            <div class="pt-3">
              <h2 class="pt-3 pl-4">Parts Sistemas provee una gran variedad de terminales de atención que satisfacen los requerimientos de cada cliente soportando las aplicaciones más diversas</h2>
              <v-container
                fluid
                grid-list-md
              >
